...
```text
database_assignments/chapter02/chapter02_answer.md
```

이미지 폴더:

```text
database_assignments/chapter02/images/
```

LMS 제출 URL:

```text
https://github.com/pang789789/llm-data-analysis-course/blob/main/database_assignments/chapter02/chapter02_answer.md
```
